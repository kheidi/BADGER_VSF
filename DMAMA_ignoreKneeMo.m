...
sumForce = 0;
sumMoment = 0;
for i = 1:length(moment_h)
    if moment_h(i,2) >= ur1FirstStep && moment_h(i,2) < ur1LastStep + 1 || ...
            moment_h(i,2) >= ur2FirstStep && moment_h(i,2) < ur2LastStep + 1    
        count = count + 1;
        sumForce = sumForce + sagForce(i,1);
        sumMoment = sumMoment + moment_h(i,1);
    end
end
...
sumMoment = 0;
for i = 1:length(moment_h)
    if moment_h(i,2) >= lg1FirstStep && moment_h(i,2) < lg1LastStep + 1 || ...
            moment_h(i,2) >= lg2FirstStep && moment_h(i,2) < lg2LastStep + 1 || ...
                moment_h(i,2) >= lg3FirstStep && moment_h(i,2) < lg3LastStep + 1
        count = count + 1;
        sumForce = sumForce + sagForce(i,1);
        sumMoment = sumMoment + moment_h(i,1);
    end
...
sumMoment = 0;
for i = 1:length(moment_h)
    if moment_h(i,2) >= dr1FirstStep && moment_h(i,2) < dr1LastStep + 1 || ...
            moment_h(i,2) >= dr2FirstStep && moment_h(i,2) < dr2LastStep + 1
        count = count + 1;
        sumForce = sumForce + sagForce(i,1);
        sumMoment = sumMoment + moment_h(i,1);
    end
...
sumMoment = 0;
for i = 1:length(moment_h)
    if moment_h(i,2) >= us1FirstStep && moment_h(i,2) < us1LastStep + 1 || ...
            moment_h(i,2) >= us2FirstStep && moment_h(i,2) < us2LastStep + 1
        count = count + 1;
        sumForce = sumForce + sagForce(i,1);
        sumMoment = sumMoment + moment_h(i,1);
    end
...
sumMoment = 0;
for i = 1:length(moment_h)
    if moment_h(i,2) >= ds1FirstStep && moment_h(i,2) < ds1LastStep + 1 || ...
            moment_h(i,2) >= ds2FirstStep && moment_h(i,2) < ds2LastStep + 1
        count = count + 1;
        sumForce = sumForce + sagForce(i,1);
        sumMoment = sumMoment + moment_h(i,1);
    end
